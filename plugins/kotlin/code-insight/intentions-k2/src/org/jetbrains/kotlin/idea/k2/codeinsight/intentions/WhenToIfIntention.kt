...
internal class WhenToIfIntention :
    ...
    override fun apply(element: KtWhenExpression, context: Context, project: Project, editor: Editor?) {
        ...
        editor?.let {
            editor.caretModel.moveToOffset(newPropertyNeededNameSelection.textOffset)
            /**
             ...
             */
            KotlinVariableInplaceRenameHandler().doRename(newPropertyNeededNameSelection, editor, null)
        }
    }
